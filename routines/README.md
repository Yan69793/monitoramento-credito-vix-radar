...
| `VIXRadar-Reconciliacao-CVM` | Seg **12:00** BRT | `scripts/predictive/reconciliar_ipe_cvm.ps1` | Reconcilia IPE CVM (RJ/RE/default) vs estado semanal do Radar; publica KV `radar:reconciliacao_cvm:latest` + nota Obsidian. Sem LLM. Era 08:00: o zip do ano corrente é republicado pela CVM na segunda de manhã (medido 21/09/2026 às 08:53 BRT) e a execução das 08:00 pegou 404 (RECONCILE-CVM404B) |
