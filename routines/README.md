...
| `VIXRadar-Health-Watch` | Seg-Sex 08:00-20:00, a cada 15 min | `watch-vixradar-health.ps1` | Vigia de health fora de sessão (criada 13/08, `HEALTHWATCH1`), alerta por e-mail em ~15 min se degradar. Não estava documentada aqui até esta sessão |
