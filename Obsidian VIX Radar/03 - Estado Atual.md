...
> [!info] 09/09 BRT — **Roteamento LIGHT/FULL implementado localmente e testado.** `LIGHT = deepseek/deepseek-v4-flash-0731`. `FULL` ainda resolve para Flash por ausência de credencial OpenRouter disponível no shell. Nenhum commit, push ou deploy foi feito. Nenhuma varredura real foi executada.
