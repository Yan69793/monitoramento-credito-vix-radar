...
Atualizado: 2026-07-07 ~21:15 BRT (prod: Worker **v4.9.148** + Frontend **v201.71**, ambos deployados — `GET /` `versao:"v4.9.148"`, `version.json` v201.71; repo à frente: Frontend **v201.72** commitado com fix P1 XSS, deploy PENDENTE). Rotina v2: [[27 - Otimizacao Tokens Rotina Noturna]] · [[29 - Rotina Noturna 2026-06-20]] · [[rotinas/2026-06-22-haiku-12]] · [[rotinas/2026-06-22-haiku-13]] · [[35 - Auditoria Completa 2026-07-02]] · [[rotinas/2026-07-03-haiku-10]] · [[rotinas/2026-07-02-noturno-v2]] · [[40 - Auditoria Geral Backend Frontend 2026-07-05]] · [[41 - Auditoria Completa 2026-07-06]] · [[42 - Auditoria Geral Backend Frontend 2026-07-06]] · [[44 - Auditoria Geral Backend Frontend 2026-07-07]] · [[45 - Auditoria Geral 2026-07-07 (noite)]].
...
> [!success] Fix P1 v201.72 — janela de corrida XSS em carregarAlertasAnbima — commitado, deploy PENDENTE
> O override seguro (`esc()`) de `window.carregarAlertasAnbima` acontecia dentro de `setTimeout(...,50)`; durante 50ms o binding usava a função original sem escape. Removido o wrapper → override imediato (commit `e258893`). `node --check` do patch OK, sem drift source/deploy_zip. Deploy Pages pendente; regenerar `version.json`→v201.72. Detalhe: [[45 - Auditoria Geral 2026-07-07 (noite)]].
