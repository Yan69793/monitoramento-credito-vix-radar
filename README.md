...
```
api/
  v4.9.236.js        ← bundle Worker em produção (bundle Wrangler, NÃO editar)
  wrangler.toml      ← config de deploy: main, bindings, cron triggers, custom domain

app/
  index.html         ← frontend canônico (CACHE_VERSION=v202.36)
...
|---|---|---|
| Worker `radar-credito-api` | v4.9.236 | 2026-09-03 |
| Frontend `vixradar.com` | v202.36 | 2026-09-02 |
