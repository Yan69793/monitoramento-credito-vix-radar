...
```
api/
  v4.9.214.js        ← bundle Worker em produção (bundle Wrangler, NÃO editar)
  wrangler.toml      ← config de deploy: main, bindings, cron triggers, custom domain

app/
  index.html         ← frontend canônico (CACHE_VERSION=v202.32)
...
|---|---|---|
| Worker `radar-credito-api` | v4.9.214 | 2026-08-24 |
| Frontend `vixradar.com` | v202.32 | 2026-08-24 |
