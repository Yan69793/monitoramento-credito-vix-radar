...
```
api/
  v4.9.203.js        ← bundle Worker em produção (bundle Wrangler, NÃO editar)
  wrangler.toml      ← config de deploy: main, bindings, cron triggers, custom domain

app/
  index.html         ← frontend canônico (CACHE_VERSION=v202.12)
...
|---|---|---|
| Worker `radar-credito-api` | v4.9.203 | 2026-08-19 |
| Frontend `vixradar.com` | v202.12 | 2026-08-19 |
