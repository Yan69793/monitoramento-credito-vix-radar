...
```
api/
  v4.9.238.js        ← bundle Worker em produção (bundle Wrangler, NÃO editar)
  wrangler.toml      ← config de deploy: main, bindings, cron triggers, custom domain

app/
  index.html         ← frontend canônico (CACHE_VERSION=v202.37)
...
|---|---|---|
| Worker `radar-credito-api` | v4.9.238 | 2026-09-04 |
| Frontend `vixradar.com` | v202.37 | 2026-09-04 |
