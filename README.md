...
```
api/
  v4.9.191.js        ← bundle Worker em produção (bundle Wrangler, NÃO editar)
  wrangler.toml      ← config de deploy: main, bindings, cron triggers, custom domain

app/
  index.html         ← frontend canônico (CACHE_VERSION=v202.6)
...
|---|---|---|
| Worker `radar-credito-api` | v4.9.191 | 2026-08-12 |
| Frontend `vixradar.com` | v202.6 | 2026-08-09 |
