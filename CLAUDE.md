...
|------------|----------|------------|-----|
| Worker | **v4.9.178** | `api/wrangler.toml` → **v4.9.178.js** (sincronizado automaticamente em 24/07 contra o health de producao) | https://api.vixradar.com |
| Frontend | **v201.87** | `app/index.html` → **v201.87** (sincronizado automaticamente em 24/07) | https://vixradar.com |
