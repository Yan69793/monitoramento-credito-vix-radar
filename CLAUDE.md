...
|------------|----------|------------|-----|
| Worker | **v4.9.166** | `api/wrangler.toml` → **v4.9.166.js** (sincronizado automaticamente em 19/07 contra o health de produção) | https://api.vixradar.com |
| Frontend | **v201.79** | `app/index.html` → **v201.79** (sincronizado automaticamente em 19/07) | https://vixradar.com |
