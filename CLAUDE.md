...
|------------|----------|------------|-----|
| Worker | **v4.9.176** | `api/wrangler.toml` → **v4.9.176.js** (sincronizado automaticamente em 24/07 contra o health de producao) | https://api.vixradar.com |
| Frontend | **v201.85** | `app/index.html` → **v201.85** (sincronizado automaticamente em 23/07) | https://vixradar.com |
