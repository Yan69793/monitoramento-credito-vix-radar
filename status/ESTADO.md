...
> [!info] 25/08 (noite) — horários invertidos e nasce a varredura pontual. Worker **v4.9.216**.
...
> parados na fila de deferidos** por teto, backlog que antes só era revisitado pela
> rotina do dia seguinte, que deferia de novo. A CVM também repôs o arquivo que sumiu em
> 23/08, publicado às 07h58 e ingerido só às 12h30.
...
- **ABERTO 25/08 (DEFERIDO-BACKLOG1, P2, observação):** o `modo=pontual` em produção acusou **34 emissores parados na fila de deferidos** por teto de tokens. Até hoje esse backlog só era revisitado pela rotina do dia seguinte, que deferia de novo. A Sentinela drena 8 por execução, então em tese ele some, mas o número inicial sugere que o teto de 700k da noturna está apertado para 103 emissores. Não mexi nisso, é decisão de orçamento
