...
Última atualização: 2026-09-01 (deploy v4.9.228 em produção: DISJUNTORHOUSEKEEP1 + LOGINTIMING1, portão validado)

> [!info] 01/09 (madrugada) — v4.9.228 DEPLOYADO: os 4 achados da auditoria geral de 01/09 fechados, nenhuma frente nova aberta.
> **Status:** vigente · **Data da Versão:** 2026-09-01 · **Origem do Registro:** correção pedida pelo operador sobre a nota 98 (`Obsidian VIX Radar/98 - Auditoria Geral 2026-09-01.md`), escopo travado nos 4 achados P3/P4. Deploy via `deploy-worker.ps1 -Version v4.9.228`, commit de código `e44cd7c`, commit de deploy `8ac3e0e`, push OK.
