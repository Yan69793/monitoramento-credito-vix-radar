...
Última atualização: 2026-09-08 (Worker v4.9.243, frontend v202.42 — fix openrouter/429 da sentinela validado em execução real no dia; sem deploy. **`VIXRadar-Verificacao-Async` reabilitada** em 06/09 por decisão do operador, com MERGEDUP1 v4.9.241, REPROVADO-FAILCLOSED1 v4.9.242 e LIVENESS1/SWEEP-ORFAOS1 v4.9.243 em produção. **Frontend-QA (baseline) e D2 Fases 1–2 fechados em `origin/main=10e8e18`, sem deploy.** Blocos abaixo)
