...
Última atualização: 2026-09-05 (noite. Worker v4.9.241, frontend v202.41. **MERGEDUP1 corrigido e deployado**: verificador que reescrevia `fonte_primaria` não duplica mais evento, fix `225bda1`, deploy `99614b7`; task `VIXRadar-Verificacao-Async` segue Disabled. Blocos abaixo)
