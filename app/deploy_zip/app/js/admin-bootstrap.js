...
import './admin/shared.js?v=202.44';
import './admin/modules.js?v=202.44';
import './admin/engajamento.js?v=202.44';
import './admin/metricas.js?v=202.44';
import './admin/fase3.js?v=202.44';

// Also expose the API client and router for direct use
export { api, createApiClient, fetchWithRetry, Skeleton } from './api.js?v=202.44';
export { initRouter, navigate, onRoute, registerRoutes, getCurrentRoute } from './admin-router.js?v=202.44';
...
} from './admin/modules.js?v=202.44';

export {
  API_BASE, esc, getSenha, setSenha, authHeaders,
  postAdmin, skeletonBlock, injectBaseStyles, wrapWhenReady,
} from './admin/shared.js?v=202.44';

export { initEngajamento } from './admin/engajamento.js?v=202.44';
export { initMetricas } from './admin/metricas.js?v=202.44';
export { initFase3Polish } from './admin/fase3.js?v=202.44';
