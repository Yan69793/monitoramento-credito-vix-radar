...
import './admin/shared.js?v=202.12';
import './admin/modules.js?v=202.12';
import './admin/engajamento.js?v=202.12';
import './admin/metricas.js?v=202.12';
import './admin/fase3.js?v=202.12';

// Also expose the API client and router for direct use
export { api, createApiClient, fetchWithRetry, Skeleton } from './api.js?v=202.12';
export { initRouter, navigate, onRoute, registerRoutes, getCurrentRoute } from './admin-router.js?v=202.12';
...
} from './admin/modules.js?v=202.12';

export {
  API_BASE, esc, getSenha, setSenha, authHeaders,
  postAdmin, skeletonBlock, injectBaseStyles, wrapWhenReady,
} from './admin/shared.js?v=202.12';

export { initEngajamento } from './admin/engajamento.js?v=202.12';
export { initMetricas } from './admin/metricas.js?v=202.12';
export { initFase3Polish } from './admin/fase3.js?v=202.12';
