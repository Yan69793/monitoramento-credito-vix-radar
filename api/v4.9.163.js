...
async function __coreFetch(request, env2222) {
    ...
    if (body.action === "registrar" || body.action === "login" || body.action === "admin_auto_login" || body.action === "solicitar_reset" || body.action === "resetar_senha") {
